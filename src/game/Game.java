...
public class Game implements ActionListener {
	...
	private static final String UP_STRING = "(=^ⓛｪⓛ^=)";
	private static final String DOWN_STRING = " (=^xｪx^=)";
	...
	public Game() {
		...
		JFrame frame = new JFrame("Whack-a-Kat!");
